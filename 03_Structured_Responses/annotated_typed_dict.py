...
class Schema(TypedDict):
    key_themes: Annotated[list[str], "must write all key themes discussed in the review in a list"]
    summary: Annotated[str, "must write brief summary of review"]
    sentiment: Annotated[str, "must return sentiment of review, either Positive or Negative"]
